...
//  import pdfLidnk from "../files/Shariq_cv.pdf";
//  import pdfLink from "@/app/files/Shariq_cv.pdf"
    ...
    const interval = setInterval(() => {
      if (typewriterRef.current) {
        typewriterRef.current
          ...
          .pauseFor(1000)
          .deleteAll()
          .typeString("PHP Developer.")
          .pauseFor(1000)
          .deleteAll()
          .typeString("Laravel Developer.")
          .pauseFor(1000)
          .deleteAll()
          .typeString("Vue.js Developer.")
          .pauseFor(1000)
          .deleteAll()
    ...
    <div>
      <div className="hero-section flex flex-col items-start justify-center   text-white   h-[80vh]">
        <h1 className="text-2xl font-bold leading-10 text-[#16f2b3] md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
          ...
          <Typewriter
            onInit={(typewriter) => {
              typewriter.typeString("I'm Shariq .").start();
            }}
          />
        </h1>
        ...
        <div className="my-8 flex items-center gap-5">
          <Link
            href={"https://github.com/shariqshanu"}
            target="_blank"
            rel="noreferrer"
          ...
          <Link
            href={"https://www.linkedin.com/in/shariq-ashraf-578764278/"}
            target="_blank"
            rel="noreferrer"
            className="transition-all text-pink-500 hover:scale-125 duration-300"
          >
          ...
          <Link
            href="mailto:shariqashraf.dev@gmail.com"
            target="_blank"
            rel="noreferrer"
            className="transition-all text-pink-500 hover:scale-125 duration-300"
          >
